            ...
            >
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="shop-all-products.html">Shop All Products</a>
                  </li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <a href="shop-all-services.html">Shop All Services</a>
                  </li>
          ...
          <li class="cart-box">
            <ul class="cart-list">
              <li>
                <a href="#" class="photo"
                  ><img
                    src="images/products/electronics/lenovo.jpg"
                    class="cart-thumb"
                    alt=""
                /></a>
              ...
              <li class="total">
                <a href="cart.html" class="btn btn-default hvr-hover btn-cart"
                  >VIEW CART</a
                >
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-12">
              <div class="account-box">
                <div class="service-box">
                  <div class="service-icon">
                    <router-link :to="getRouteWithUserId('/editProfile')">
