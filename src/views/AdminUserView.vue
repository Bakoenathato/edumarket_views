<template>
  <div>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light navbar-default bootsnav">
        <div class="container">
          <div class="navbar-header">
            ...
            <router-link to="/" class="btn btn-outline-primary ml-auto">Home</router-link>
          </div>
        </div>
      </nav>
    </header>
    ...
    <div class="container mt-4">
      <h2>User List</h2>
      <button class="btn btn-success mb-3" @click="createUser">Create User</button>
...
export default {
  ...
  methods: {
    ...
    createUser() {
      this.$router.push({ name: 'AdminCreateUserView' });
    },
    editUser(userId) {
