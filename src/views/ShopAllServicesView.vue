            ...
            <ul class="cart-list">
              <li>
                <router-link :to="getRouteWithUserId('#')">
                  <img
                    src="../assets/images/products/electronics/lenovo.jpg"
                    class="cart-thumb"
                    alt=""
                  />
                </router-link>
                    ...
                    <div class="row">
                      ...
                      >
                        <div class="products-single fix">
                            ...
                            <div class="mask-icon">
                              <ul>
                                <li style="background-color: #007bff">
                                  <router-link
                                    :to="
                                      getServiceDetailsRoute(service.serviceId)
                                    "
                                    data-toggle="tooltip"
                          ...
                          <div class="why-text">
                            <router-link
                              :to="getServiceDetailsRoute(service.serviceId)"
                            >
          ...
          <div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
            <div class="product-categori">
              ...
              <div class="filter-sidebar-left">
                ...
                >
                  <a
                    v-for="(count, serviceCategory) in serviceCategoryCounts"
                    :key="serviceCategory"
                    href="#"
                    @click.prevent="selectServiceCategory(serviceCategory)"
                    class="list-group-item list-group-item-action"
                    :class="{
                      active: selectedServiceCategory === serviceCategory,
                    }"
                    style="color: #007bff"
                  >
                    {{ serviceCategory }}
  ...
  methods: {
    ...
    getServiceDetailsRoute(serviceId) {
      ...
      return {
        ...
        query: { serviceId: serviceId, userId },
      };
    },
    scrollToTop() {
