            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
              <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li>
                      <router-link :to="{ path: '/services', query: { category: 'All', userId } }">Shop All Services</router-link>
                    </li>
                    <li>
                      <router-link :to="{ path: '/services', query: { category: 'TUTORING', userId } }">Tutoring</router-link>
                    </li>
                    <li>
                      <router-link :to="{ path: '/services', query: { category: 'WOMENHAIRSTYLING', userId } }">Women Hairstyling</router-link>
                    </li>
                    <li>
                      <router-link :to="{ path: '/services', query: { category: 'MENHAIRCUTS', userId } }">Men Hair Cuts</router-link>
                    </li>
                    <li>
                      <router-link :to="{ path: '/services', query: { category: 'OTHER', userId } }">Other</router-link>
                    </li>
                    <li>
                        ...
                        >
                          <div class="products-single fix">
                            <div class="box-img-hover">
                              <img
                                :src="`data:image/jpeg;base64,${service.serviceImage}`"
                                class="img-fluid"
                              ...
                              <div class="mask-icon">
                                <ul>
                                  <li style="background-color: #007bff">
                                    <router-link
                                      :to="getServiceDetailsRoute(service.id)"
                                      data-toggle="tooltip"
                            ...
                            <div class="why-text">
                              <router-link :to="getServiceDetailsRoute(service.id)">
  ...
  export default {
    ...
    mounted() {
      fetch("http://localhost:8080/edumarket/serviceproduct/getall")
        ...
        .then((data) => {
          ...
          console.log("Fetched services:", this.serviceproducts);
        })
        .catch((error) => {
    ...
    computed: {
      filteredServices() {
        ...
        const filtered = this.serviceproducts.filter((service) => {
      ...
      categoryCounts() {
        const counts = { All: this.serviceproducts.length };
        this.serviceproducts.forEach((service) => {
    ...
    methods: {
      ...
      getServiceDetailsRoute(serviceId) {
        const userId = Number(this.$route.query.userId);
        return { path: `/service-details`, query: { id: serviceId, userId } };
      },
      scrollToTop() {
