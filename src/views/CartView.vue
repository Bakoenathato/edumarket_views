                ...
                <div class="container">
                    ...
                    <div class="attr-nav">
                        <ul>
                            ...
                            <li title="Cart"><a href="cart.html">
            ...
            <div class="container">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="thumbnail-img">
                                            <a href="#">
                                                <img class="img-fluid" src="../assets/images/products/electronics/lenovo.jpg"
                                                    alt="" />
                                            </a>
                                        </td>
                                        <td class="name-pr">
                                    ...
                                    <tr>
                                        <td class="thumbnail-img">
                                            <a href="#">
                                                <img class="img-fluid" src="..//assets/images/categories/products/electronics.jpg"
                                                    alt="" />
                                            </a>
                                        </td>
                                        <td class="name-pr">
                ...
                <div class="row my-5">
                    ...
                    <div class="col-12 d-flex shopping-box"><a href="checkout.html"
                            class="ml-auto btn-primary">Checkout</a> </div>
                </div>
