                ...
                <div class="col-xl-5 col-lg-5 col-md-6">
                    <div id="carousel-example-1" class="single-product-slider carousel slide" data-ride="carousel">
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active"> <img class="d-block w-100" src="../assets/images/products/electronics/lenovo.jpg" alt="First slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="../assets/images/products/electronics/lenovo.jpg" alt="Second slide"> </div>
                            <div class="carousel-item"> <img class="d-block w-100" src="../assets/images/products/electronics/lenovo.jpg" alt="Third slide"> </div>
                        </div>
                    ...
                    <div class="single-product-details">
						...
						<div class="price-box-bar">
							<div class="cart-and-bay-btn">
								<a class="btn-primary" data-fancybox-close="" href="#">Buy</a>
								<a class="btn-primary" data-fancybox-close="" href="#">Add to cart</a>
                                <a class="btn-primary" href="#"><i class="fas fa-heart"></i> Add to wishlist</a>
							</div>
						</div>
                    </div>
                </div>
